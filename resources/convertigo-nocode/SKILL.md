...
- Skill guidance version: `2026-08-28.batch-reveal-v2`.
...
3. For new forms:
   ...
   - Before compiling, apply the native design pass below to every page. Functional components alone are not a finished application: choose spacing and grouping deliberately, then author the actual style objects rather than merely describing the intended appearance.
