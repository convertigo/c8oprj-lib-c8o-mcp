...
(function () {
  ...
  function buildSkillMarkdown(mcpUrl) {
    ...
    return [
      ...
      "   - Project review, audit, expertise note, client synthesis, hardening plan, or V1/V2 comparison: use the optional project review route below. This route is review-only unless the user explicitly asks for code changes.",
