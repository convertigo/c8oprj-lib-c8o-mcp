...
(function () {
  ...
  function buildSkillMarkdown(mcpUrl) {
    ...
    return [
      ...
      "7. If the user asks for a project review, audit, expertise note, client synthesis, hardening plan, recommendations, or V1/V2 comparison, read `convertigo://resources/convertigo-project-review` before inspecting or reporting.",
      "8. Do not call `Convertigo_rag-query` before the selected guide has been read and tried.",
      "",
      "## Headless Discipline",
      "",
