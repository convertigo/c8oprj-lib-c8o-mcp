...
(function () {
  ...
  function buildSkillMarkdown(mcpUrl) {
    ...
    return [
      ...
      "3. When an exact guide URI is named below, skip broad catalog/list calls and read that URI directly with `Convertigo_requestable-execute` -> `ConvertigoMCP.mcp_resources_read` using `variables.uri`. Do not use `variables.path` for resource reads.",
