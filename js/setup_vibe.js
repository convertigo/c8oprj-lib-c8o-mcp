...
(function () {
  ...
  function buildSkillMarkdown(mcpUrl) {
    ...
    return [
      ...
      "7. If the user asks for a project review, audit, expertise note, client synthesis, hardening plan, recommendations, or V1/V2 comparison, use the optional project review route below. This route is review-only unless the user explicitly asks for code changes.",
